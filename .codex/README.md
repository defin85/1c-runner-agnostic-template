...
- Для compact first-hour skill routing в generated project используйте `automation/context/recommended-skills.generated.md`.
- Перед executable imported compatibility skills используйте `make imported-skills-readiness`.
