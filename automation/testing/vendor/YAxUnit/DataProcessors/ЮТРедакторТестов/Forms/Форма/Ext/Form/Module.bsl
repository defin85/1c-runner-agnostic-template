...
#Если ВебКлиент Тогда
		EditorURL = АдресРедактораИзМакета();
#Иначе
...
&НаСервере
Функция АдресРедактораИзМакета()

	Возврат ЮТРеактивныйСервер.ЗагрузитьПриложениеИзМакета("ОбщийМакет.ЮТMonacoEditor", Новый УникальныйИдентификатор());
