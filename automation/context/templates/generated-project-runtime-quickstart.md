...
- описывает `bdd-warm-service` как fail-closed operator-local Vanessa contour, который требует `automation/context/operator-local-targets.json` и local-private Vanessa inputs;
