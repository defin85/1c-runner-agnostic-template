...
| --- | --- | --- |
| `runtime-profile-schema.structured-schema-version-2` | `env/wsl.example.json`, `env/README.md`, `README.md`, `scripts/lib/runtime-profile.sh`, `scripts/lib/onec.sh` | `bash tests/smoke/runtime-direct-platform-xvfb-contract.sh`, `bash tests/smoke/copier-update-ready.sh`, `openspec validate add-direct-platform-xvfb-wrapper --strict --no-interactive` |
| `runtime-profile-schema.redacted-launcher-artifacts` | `scripts/lib/capability.sh`, `scripts/lib/onec.sh`, `scripts/diag/doctor.sh`, `scripts/adapters/direct-platform.sh` | `bash tests/smoke/runtime-direct-platform-xvfb-contract.sh`, `bash tests/smoke/runtime-doctor-contract.sh` |
