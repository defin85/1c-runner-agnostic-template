...
| --- | --- | --- |
| `generated-project-agent-guidance` / `Local Working-Area Routing For Generated Repositories` | `src/AGENTS.md`, `src/README.md`, `docs/agent/generated-project-index.md`, `docs/template-maintenance.md`, `scripts/bootstrap/generated-project-surface.sh`, `automation/context/template-managed-paths.txt` | `bash tests/smoke/bootstrap-agents-overlay.sh`, `bash tests/smoke/copier-update-ready.sh`, `make agent-verify` |
...
| `template-overlay-delivery` / `Overlay Update Retires Legacy Source-Root Routing Files` | `scripts/bootstrap/generated-project-surface.sh`, `README.md`, `docs/template-maintenance.md`, `tests/smoke/copier-update-ready.sh` | `bash tests/smoke/copier-update-ready.sh`, `make agent-verify` |
