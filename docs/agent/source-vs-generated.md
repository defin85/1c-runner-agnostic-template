...
- Если вы работаете в generated project, держите curated truth в `automation/context/project-map.md`, а generated-derived inventory refresh-ите через `./scripts/llm/export-context.sh --write`.
