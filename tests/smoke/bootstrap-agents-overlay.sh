...
src_readme_file="$project_root/src/README.md"
...
assert_contains "$manifest_file" "src/README.md"
...
assert_contains "$src_readme_file" "LoadConfigFromFiles"
assert_contains "$src_readme_file" "статического анализа BSL"
assert_contains "$src_readme_file" "сравнения изменений в Git"
...
assert_contains "$metadata_index_file" '"src/cfe/MainExtension"'
