...
assert_contains "$rendered_root/AGENTS.md" 'Use [docs/agent/review.md](docs/agent/review.md), [docs/agent/operator-local-runbook.md](docs/agent/operator-local-runbook.md), [env/README.md](env/README.md), [.agents/skills/README.md](.agents/skills/README.md), and [docs/exec-plans/README.md](docs/exec-plans/README.md) as the main follow-up routers.'
...
assert_jq "$rendered_root/automation/context/metadata-index.generated.json" '.inventoryRole == "generated-derived" and .authoritativeDocs.projectMap == "automation/context/project-map.md" and .authoritativeDocs.architectureMap == "docs/agent/architecture-map.md" and .authoritativeDocs.runtimeQuickstart == "docs/agent/runtime-quickstart.md" and .authoritativeDocs.operatorLocalRunbook == "docs/agent/operator-local-runbook.md" and .authoritativeDocs.codexWorkflows == "docs/agent/codex-workflows.md" and .authoritativeDocs.projectDeltaHints == "automation/context/project-delta-hints.json" and .authoritativeDocs.projectDeltaHotspots == "automation/context/project-delta-hotspots.generated.md" and .authoritativeDocs.review == "docs/agent/review.md" and .authoritativeDocs.envReadme == "env/README.md" and .authoritativeDocs.executionPlans == "docs/exec-plans/README.md" and .authoritativeDocs.runtimeProfilePolicy == "automation/context/runtime-profile-policy.json" and .authoritativeDocs.hotspotsSummary == "automation/context/hotspots-summary.generated.md" and .entrypointInventory.configurationRoots == ["src/cf","src/cfe","src/epf","src/erf"]' "generated-metadata-index"
