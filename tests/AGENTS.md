...
- Если меняется runtime truth для generated repo, синхронно обновляйте `automation/context/runtime-support-matrix.md` и `automation/context/runtime-support-matrix.json`.
