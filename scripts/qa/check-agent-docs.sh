...
require_contains ".agents/skills/1c-load-task-src/SKILL.md" "--bead"
...
require_contains ".agents/skills/1c-load-task-src/SKILL.md" "./scripts/git/task-trailers.sh render --bead <id> --work-item <id>"
require_contains ".claude/skills/1c-load-task-src/SKILL.md" "--bead"
...
require_contains ".claude/skills/1c-load-task-src/SKILL.md" "./scripts/git/task-trailers.sh render --bead <id> --work-item <id>"
